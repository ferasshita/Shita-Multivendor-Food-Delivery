...
const detectAndSetLanguage = async () => {
  try {
    const storedLanguage = await AsyncStorage.getItem('shita-language');
    ...
    await AsyncStorage.removeItem('shita-language');
    await AsyncStorage.removeItem('shita-language-name');
  } catch (error) {
