...
function Account(props) {
  ...
  const fetchSelectedLanguage = async () => {
    const lang = await AsyncStorage.getItem('shita-language-name')
              ...
              <View style={styles(currentTheme).subContainer}>
                ...
                <View>
                  ...
                  <ButtonContainer
                    ...
                    status='null'
                    onPress={() => {
                      Linking.openURL('https://multivendor.shita.com/terms')
                    }}
                  />
                  <View style={styles(currentTheme).line} />
                  ...
                  <ButtonContainer
                    ...
                    status='null'
                    onPress={() => {
                      Linking.openURL('https://multivendor.shita.com/privacy')
                    }}
                  />
                </View>
