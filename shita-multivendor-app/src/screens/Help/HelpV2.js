  ...
  const [links, setLinks] = useState([
    {
      ...
      url: 'https://shita.com/shita-multi-vendor/'
    },
    {
      title: t('titleDocs'),
      url: 'https://shita.com/multi-vendor-doc/'
    },
    {
      title: t('titleBlog'),
      url: 'https://shita.com/blog/'
    },
    {
    ...
    setLinks([
      {
        title: t('titleProductPage'),
        url:
          'https://shita.com/shita-multivendor-open-source-food-delivery-solution/'
      },
      {
        title: t('titleDocs'),
        url: 'https://shita.com/multivendor-documentation/'
      },
      {
        title: t('titleBlog'),
        url:
          'https://shita.com/blogs-shita-open-source-food-delivery-solutions/'
      },
      {
        title: t('titleAboutUs'),
