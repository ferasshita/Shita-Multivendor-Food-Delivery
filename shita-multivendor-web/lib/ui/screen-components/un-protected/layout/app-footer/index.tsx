...
const AppFooter = () => {
  ...
  const partnerWithShita = {
    title: t("Footer.partnerWithShita"),
    links: [
  ...
  const products = {
    ...
    links: [
      {
        label: t("Footer.shitaRider"),
        link: "https://play.google.com/store/apps/details?id=com.shita.multirider&hl=en",
        internal: false,
      },
      {
        label: t("Footer.shitaRestaurant"),
        link: "https://play.google.com/store/apps/details?id=multivendor.shita.restaurant&hl=en",
        internal: false,
      },
    ],
  };
  ...
  const followUs = {
    ...
    links: [
      ...
      },
      {
        ...
        link: "https://www.facebook.com/shita/",
        internal: false,
      },
      {
        label: t("Footer.linkedIn"),
        link: "https://www.linkedin.com/company/shita/?originalSubdomain=pk",
        internal: false,
      },
    ],
  };
    ...
    >
      <div className="mx-auto my-[30px] md:mt-[60px] md:mb-[60px] p-4 flex md:items-center md:justify-center flex-col">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 w-screen md:w-full md:px-0 px-4">
          ...
          <div className="p-2">
            <FooterLinks section={partnerWithShita} />
          </div>
          <div className="p-2">
