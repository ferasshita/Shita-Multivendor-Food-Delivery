...
const Rider = () => {
  ...
  const cards = [
    {
      heading: t("shita_rider_page_name_card1_heading"),
      text: t("shita_rider_page_name_card1_text"),
      image: growth,
      color: "#f7fbfe",
    },
    {
      heading: t("shita_rider_page_name_card2_heading"),
      text: t("shita_rider_page_name_card2_text"),
      image: getMoreOrders,
      color: "#faf7fc",
    },
    {
      heading: t("shita_rider_page_name_card3_heading"),
      text: t("shita_rider_page_name_card3_text"),
  ...
  return (
    <div className="w-screen h-auto">
      <Heading heading={t("shita_rider_page_name_main_heading")} />
      <StartingImage image={RiderBanner} />
      <WhyChoose
        heading={t("shita_rider_page_name_why_heading")}
        subHeading={t("shita_rider_page_name_why_subheading")}
      />
      <WhyCardsList cards={cards} />
      <hr className="w-[30%] ml-12 border-4 border-primary-color my-12 rounded" />
      <EmailForm
        heading={t("shita_rider_page_name_form_heading")}
        role={t("shita_rider_page_name_form_role")}
      />
    </div>
  );
};
