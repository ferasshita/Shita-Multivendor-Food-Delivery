...
import shitaApp from "@/public/assets/images/png/shitaApp.png";
...
const RestInfo = () => {
  ...
  const sideCards = [
    {
      image: shitaApp,
      heading: t("how_Shita_works"),
      subHeading: t("how_Shita_works_desc"),
      right: false
    },
    {
  ...
  return (
    <div className='w-screen h-auto'>
      <Heading
        heading={t("reach_more_customers_and_grow_your_business_with_Shita")}
        subHeading={t("partner_with_Shita_to_create_more_sales")}
      />
      <StartingImage image={restaurantBanner} />
      <WhyChoose
        heading={t("why_deliver_with_Shita")}
